  ...
  return (
    <div className="space-y-6">
      ...
      <div className="proto-banner">
        ...
        <div>
          <strong>Prototype Dashboard</strong> — Metric cards below use <em>sample demo values</em> for illustration.
          All AI predictions and advisories are generated by rule-based prototype engines using manually entered inputs.
          No live sensors, IoT, or satellite data are connected.
        </div>
      </div>
